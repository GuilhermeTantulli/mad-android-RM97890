...
// fun main() {
//     val nome = "Guilherme" //variavel tipo string -- pode ser alterada (mutável)
//     var idade = 25 //variável tipo int         -- não pode ser alterada (não mutável)
...
//     var status: Boolean = true //se true o status é on-line se falso o status é off-line (0 ou 1)
